...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "FeatureSlidesBlock".
 */
export interface FeatureSlidesBlock {
  heading: string;
  description?: string | null;
  items: {
    title: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "FeatureSlidesBlock_select".
 */
export interface FeatureSlidesBlockSelect<T extends boolean = true> {
  heading?: T;
  description?: T;
  items?:
    | T
